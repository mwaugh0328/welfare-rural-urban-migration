...
\renewcommand{\arraystretch}{1.2}
\begin{center}
\caption{Data and Models with no $\bar{u}$ and $\rho=0$}
\begin{tabular}{l l c c c}
\hline
\hline
...
\renewcommand{\arraystretch}{1.2}
\begin{center}
\caption{Data and Model with Subsistence Consumption}
...
\renewcommand{\arraystretch}{1.2}
\begin{center}
\caption{Data and Model and Migration Costs}
\begin{tabular}{l c c c}
\hline
\hline
...
\renewcommand{\arraystretch}{1.2}
\begin{center}
\caption{Data and Model with Additive Migration Disutility}
\begin{tabular}{l c c c}
\hline
\hline
...
Control: Consumption increase of migrants (OLS)                 & \phantom{0.}10    & \phantom{0.}10    & \phantom{0.}08   \\
