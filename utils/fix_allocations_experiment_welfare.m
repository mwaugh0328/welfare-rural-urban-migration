function [assets, move, cons_eqiv] = fix_allocations_experiment_welfare(assets, move, params, perm_types, value_funs)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    v_expr_rural_not(:,zzz) = sum(pitest.*(sigma_nu_not.*log(1./max(pitest, 10^-25))  + [v_stay_rural_not, v_move_seasn_not, v_move_rural_not]),2);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    v_expr_rural_exp(:,zzz) = sum(pitest.*(sigma_nu_not.*log(1./max(pitest, 10^-25))  + [v_stay_rural_exp, v_move_seasn_exp, v_move_rural_exp]),2);
