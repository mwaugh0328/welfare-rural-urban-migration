function theta = calibrate_model_appendix(cal_params,moments,specs, seed, R, beta, vguess, flag)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
model_moments = compute_outcomes_appendix(cal_params, specs, seed, R, beta, vguess, 0);
