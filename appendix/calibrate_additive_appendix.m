function theta = calibrate_additive_appendix(cal_params,moments,specs, seed, R, beta, min_consumption, perm_movecost, vguess, flag)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
model_moments = compute_outcomes_additive(cal_params, specs, seed, R, beta, min_consumption, perm_movecost, vguess, 0);
