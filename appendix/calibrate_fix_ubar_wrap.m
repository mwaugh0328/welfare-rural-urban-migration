...
ObjectiveFunction = @(xxx) calibrate_fix_ubar((xxx), moments, [], [], R, beta, min_consumption, perm_movecost,  vguess,1);

UB = [5.25, 0.60, 5.70, 0.95, 0.85, 0.85, 5.50, 1.00];
LB = [0.25, 0.30, 1.00, 0.05, 0.15, 0.15, 0.15, 0.01];

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
obj_old = calibrate_fix_ubar(x1, moments, [], [], R, beta, min_consumption, perm_movecost, vguess,1);
...
for xxx = 1:5
    ...
    obj_new = calibrate_fix_ubar(x1_new, moments, [], [], R, beta, min_consumption, perm_movecost,  vguess,1);
...
if obj_new < obj_old
    ...
    save appendix_fix_ubar x1 obj_new
