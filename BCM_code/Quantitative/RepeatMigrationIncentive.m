...
parm.m = 2.5; %the net return to migration
...
Z = (parm.x - parm.sub).^(1-parm.sigma)/(1-parm.sigma) + parm.beta*(interp1(parm.x,V,parm.s1,'linear')*parm.p1);%Z is the value of migrating.
...
print(figure,'-dpdf',sprintf('Figures/RepeatMigrationIncentive_Cutoffs.pdf'));
clear figure;

figure = figure();
plot(RA,ppval(ppH,cutpoint)-ppval(ppH,cutpoint_I),RA,ppval(ppH,cutpoint)-ppval(ppH,cutpoint_Credit),RA,ppval(ppH,cutpoint)-ppval(ppH,cutpoint_UCT))
axis([0 8 10 35])
hleg1 =  legend('Cash Incentive', 'Credit Incentive', 'UCT') ; 
xlabel('Risk Aversion')
ylabel('Portion of Households')
title('Portion of Households Induced To Migrate')
print(figure,'-dpdf',sprintf('Figures/RepeatMigrationIncentive_Induced.pdf'));
clear figure;
...
figure = figure();
plot(t,induceable(10,:),t,induceable(15,:),t,induceable(20,:),t,induceable(30,:),t,induceable(40,:),t,induceable(50,:),t,induceable(60,:),t,induceable(70,:))
hleg1 =  legend('RA: 1','RA:1.5','RA:2','RA: 3','RA:4','RA:5','RA:6','RA:7') ; 
xlabel('Time Periods')
ylabel('Portion of Households Induceable')
title('Induceable Households Over Time')
print(figure,'-dpdf',sprintf('Figures/RepatMigrationIncentive_Induceable.pdf'));
clear figure;
