...
parm.epsilon = 1e-4; %accuracy for convergence
parm.xgrid = 900;%grid points
...
RA(j)=parm.sigma;
save (sprintf('Data/iteration_RA%1$d',j));
...
print(figure,'-dpdf',sprintf('Figures/WithSavings_Cutoffs.pdf'));
clear figure;
...
print(figure,'-dpdf',sprintf('Figures/WithSavings_Induced.pdf'));
clear figure;
